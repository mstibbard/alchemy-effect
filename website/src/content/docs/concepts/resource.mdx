...
See [Provider › Authoring a custom provider](/concepts/provider#authoring-a-custom-provider)
for the lifecycle hooks (`create`, `update`, `delete`, `diff`,
`read`) you'll implement.
